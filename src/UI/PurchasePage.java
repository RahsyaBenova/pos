...
public class PurchasePage extends javax.swing.JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (purchaseTable.getSelectedRow()<0)
            ...
            if(opt==JOptionPane.YES_OPTION) {
                new ProductPOS().deletePurchaseDAO((int) purchaseTable.getValueAt(purchaseTable.getSelectedRow(),0));
                new ProductPOS().editPurchaseStock(prodCode, quantity);
                loadDataSet();
            }
        }
    ...
    private void codeTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_codeTextKeyReleased
        try {
            ResultSet resultSet = new ProductPOS().getProdFromCode(codeText.getText());
            if (resultSet.next()) {
    ...
    public void loadComboBox() {
        try {
            SupplierPOS supplierDAO = new SupplierPOS();
