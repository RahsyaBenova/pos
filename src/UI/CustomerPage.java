...
public class CustomerPage extends javax.swing.JPanel {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if (codeText.getText().equals("") || nameText.getText().equals("")
            ...
            new CustomerPOS().addCustomerDAO(customerDTO);
            loadDataSet();
        }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (custTable.getSelectedRow()<0)
            ...
            if (codeText.getText().equals("") || nameText.getText().equals("")
                ...
                customerDTO.setLocation(locationText.getText());
                customerDTO.setPhone(phoneText.getText());
                new CustomerPOS().editCustomerDAO(customerDTO);
                loadDataSet();
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (custTable.getSelectedRow()<0)
            ...
            if (opt==JOptionPane.YES_OPTION) {
                new CustomerPOS().deleteCustomerDAO(custTable.getValueAt(custTable.getSelectedRow(),0).toString());
                loadDataSet();
            }
        }
    ...
    public void loadDataSet() {
        try {
            CustomerPOS customerDAO = new CustomerPOS();
