...
import pos.CustomerPOS;
import pos.ProductPOS;
...
public class SalesPage extends javax.swing.JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (salesTable.getSelectedRow()<0)
            ...
            if (opt == JOptionPane.YES_OPTION) {
                new ProductPOS().deleteSaleDAO(Integer.parseInt(
                        salesTable.getValueAt(salesTable.getSelectedRow(),0).toString()));
                new ProductPOS().editSoldStock(
    ...
    private void sellButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sellButtonActionPerformed
        if (custCodeText.getText().equals("") || prodCodeText.getText().equals("")
            ...
            try {
                ResultSet resultSet = new CustomerPOS().getCustName(custCodeText.getText());
                if (resultSet.next()) {
                    ...
                    new ProductPOS().sellProductDAO(productDTO, username);
                    loadDataSet();
                } else
    ...
    private void prodCodeTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_prodCodeTextKeyReleased
        try {
            ResultSet resultSet = new CustomerPOS().getProdName(prodCodeText.getText());
            if (resultSet.next()) {
                prodNameLabel.setText("Name: "
                        + resultSet.getString("productname")
                        + " | Available quantity: "
                        + resultSet.getString("quantity"));
                Double sellPrice = new ProductPOS().getProdSell(prodCodeText.getText());
